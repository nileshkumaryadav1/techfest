export default function StudentInfo({ student }) {
  return (
    <div className="mb-8 p-6 border border-[color:var(--border)] rounded-2xl bg-[color:var(--card)] shadow-lg">
      <h2 className="text-2xl md:text-3xl font-extrabold text-[color:var(--foreground)] mb-6 flex items-center gap-2">
        👤 Student Dashboard
      </h2>
